...
/*   Updated: 2022/09/03 19:42:48 by yed-dyb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cylinder_init(t_cy *cy, t_ambient ambient)
{
	cy->transform = matrix_mult(matrix_mult(matrix_mult(
					...
					get_rotation_matrix(rad(cy->normal.x), 'z')),
					get_rotation_matrix(rad(cy->normal.y), 'x')),
					get_rotation_matrix(rad(cy->normal.z), 'y'));
