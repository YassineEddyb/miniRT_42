...
/*   Updated: 2022/09/08 18:49:42 by yed-dyb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_RGB	get_specular(t_light_data data, t_comps comps, t_vector lightv)
{
	...
	else
	{
		...
		light_specular = data.l.ratio * factor;
