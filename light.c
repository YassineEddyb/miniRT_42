...
/*   Updated: 2022/07/28 14:37:20 by yed-dyb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
colour lightning(material m, light l, vector pos, vector v, vector n)
{
    ...
    float light_dot_n = vectorDot(lightv, n);
    ...
    if (light_dot_n < 0)
    {
        ...
        float light_diffuse = light_dot_n * m.diffuse;
       ...
       float reflect_dot_eye = vectorDot(reflectv, v);
       ...
       if (reflect_dot_eye <= 0)
       {
            ...
            float light_specular = m.specular * factor;
